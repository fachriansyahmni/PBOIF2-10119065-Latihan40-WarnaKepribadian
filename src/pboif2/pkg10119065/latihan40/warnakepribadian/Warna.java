...
public class Warna {
    ...
    public void showKepribadian(String warna) {
        if(kepribadian.containsKey(warna)) {
            System.out.println("Warna Favoritmu Adalah " + 
            getColor(warna) + warna);
            System.out.println(BLACK + kepribadian.get(warna));
        } else {
    ...
    private void setKepribadian() {
        kepribadian.put(
            ...
            + "sudah tahap puncak toleransi kemarahannya akan sulit dikontrol,"
        ...
        kepribadian.put(
            "UNGU",
            "1. Optimis,\n2. Tidak pernah ragu,\n3. Menurutnya pasangan yang ideal "
            + "adalah yang memiliki mental yang kuat,\n4. Memiliki ambisi yang besar,"
